...
Public Class rptReceiveRepair
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptReceiveRepair.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceiveRepair
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceiveRepair = New rptReceiveRepair()
        rpt.Site = Me.Site
        Return rpt
    End Function
