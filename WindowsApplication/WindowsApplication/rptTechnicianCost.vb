...
Public Class rptTechnicianCost
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptTechnicianCost.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTechnicianCost
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTechnicianCost = New rptTechnicianCost()
        rpt.Site = Me.Site
        Return rpt
    End Function
