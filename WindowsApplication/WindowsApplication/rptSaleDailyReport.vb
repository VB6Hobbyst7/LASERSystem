...
Public Class rptSaleDailyReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.rptSaleDailyReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaleDailyReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaleDailyReport = New rptSaleDailyReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
