...
Public Class rptLetterHead
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptLetterHead.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLetterHead
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLetterHead = New rptLetterHead()
        rpt.Site = Me.Site
        Return rpt
    End Function
