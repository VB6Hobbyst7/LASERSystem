...
Public Class rptRepairLabel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptRepairLabel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepairLabel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepairLabel = New rptRepairLabel()
        rpt.Site = Me.Site
        Return rpt
    End Function
