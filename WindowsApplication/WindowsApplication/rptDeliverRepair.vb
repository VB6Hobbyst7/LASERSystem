...
Public Class rptDeliverRepair
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptDeliverRepair.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeliverRepair
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeliverRepair = New rptDeliverRepair()
        rpt.Site = Me.Site
        Return rpt
    End Function
