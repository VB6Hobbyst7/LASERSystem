Public Class frmSupplier
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        Select Case cmdSave.Text
            Case "Save"
                If CheckExistDatatxt(txtSuNo, "Select SuNo from Supplier where SuNo =" & txtSuNo.Text & ";", "Supplier No is exist", True) = True Then
                    Exit Sub
                ElseIf CheckExistDatacmb(cmbSuName, "Select SuName from Supplier where SuName ='" & cmbSuName.Text & "';", "Supplier Name is exist", True) = True Then
                    Exit Sub
                End If
            ...
            Case "Edit"
                If CheckExistDatatxt(txtSuNo, "Select SuNo from Supplier where SuNo =" & txtSuNo.Text, "Supplier No was not exist in the database please check again", False) = False Then
                    Exit Sub
                End If
    ...
    Private Sub cmdDelete_Click(sender As Object, e As EventArgs) Handles cmdDelete.Click
        If CheckEmptyfieldtxt(txtSuNo, "Supplier No was empty. So, this operation couldn't be successful. Please check it and try again.") = False Then
            Exit Sub
        End If
