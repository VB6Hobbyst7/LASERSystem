Public Class frmTechnician
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        If CheckEmptyfieldtxt(txtTNo, "This data couldn't be saved to database. It's because Technician No is empty. If you want to save this, you should fill it.") = False Then
            Exit Sub
        ElseIf CheckEmptyfieldcmb(cmbTName, "This data couldn't be saved to database. It's because Technician Name is empty. If you want to save this, you should fil it.") = False Then
            Exit Sub
        End If
        Select Case cmdSave.Text
            Case "Save"
                If CheckExistDatacmb(cmbTName, "Select TName from Technician where TName='" & cmbTName.Text & "';", "Saveing is not comfortable because Technician Name which you added has already located in the database. You have to change Technician No to save.", True) = True Then
                    Exit Sub
                ElseIf CheckExistDatatxt(txtTNo, "Select TNo from Technician where TNo =" & txtTNo.Text & ";", "This data couldn't be saved to database because Technicino No which you added has already located in the database. You have to change that to save.", True) = True Then
                    Exit Sub
                End If
    ...
    Private Sub cmdDelete_Click(sender As Object, e As EventArgs) Handles cmdDelete.Click
        ...
        If CheckExistRelationsforDelete("Select TNo,SaRepNo from SalesRepair where TNo = " & txtTNo.Text, "SaRepNo",
            ...
            Exit Sub
        End If
        If CheckEmptyfieldtxt(txtTNo, "This Technician couldn't be deleted because Technician No was empty. Please fill it and try again.") = False Then
            Exit Sub
        End If
