...
#End Region
    ...
    Private Sub cmbIncomevsDateView_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbIncomevsDateView.SelectedIndexChanged
    ...
    Private Sub txtIncomevsDateCustom_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtIncomevsDateCustom.KeyPress
        OnlynumberQty(e)
    End Sub

    Private Sub cmbReceivedRepvsDateView_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbReceivedRepvsDateView.SelectedIndexChanged
    ...
    Public Sub txtIncomevsDateCustom_TextChanged(sender As Object, e As EventArgs) Handles txtIncomevsDateCustom.TextChanged
