...
Public Class rptDeliverReturn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptDeliverReturn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeliverReturn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeliverReturn = New rptDeliverReturn()
        rpt.Site = Me.Site
        Return rpt
    End Function
