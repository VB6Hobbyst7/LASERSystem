...
Public Class frmSupply
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        If CheckEmptyfieldcmb(cmbSuName, "Supplier Name යන field එක හිස්ව පවතියි. කරුණාකර අදාල Supplier තොරා ගෙන නැවත උත්සහ කරන්න.") = False Then
            Exit Sub
    ...
    Private Sub cmdDelete_Click(sender As Object, e As EventArgs) Handles cmdDelete.Click
        If CheckEmptyfieldtxt(txtSupNo, "Supply No was empty. Please check again and try agin.") = False Then
            Exit Sub
        ElseIf CheckExistDatatxt(txtSupNo, "Select SupNo from [Supply] where SupNo =" & txtSupNo.Text, "Supply No was not exist in the database. Please check it and try again.", False) = False Then
            Exit Sub
        End If
