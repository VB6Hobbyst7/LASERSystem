...
Public Class frmRepairAdvanced
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        ElseIf CheckEmptyfieldtxt(txtAmount, "Advanced එකෙහි Amount එක ඇතුලත් කරන්න.") = False Then
            Exit Sub
        End If
    ...
    Private Sub cmdDelete_Click(sender As Object, e As EventArgs) Handles cmdDelete.Click
        Dim AdminSend As Boolean = False
        Dim Remarks As String = ""
        If CheckExistDatatxt(txtAdNo, "Select AdNo from RepairAdvanced Where AdNo=" & txtAdNo.Text, "මෙම Advanced එක ඇතුලත් කර නොමැති එකකි." &
