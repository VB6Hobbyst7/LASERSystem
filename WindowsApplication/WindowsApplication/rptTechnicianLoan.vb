...
Public Class rptTechnicianLoan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptTechnicianLoan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTechnicianLoan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTechnicianLoan = New rptTechnicianLoan()
        rpt.Site = Me.Site
        Return rpt
    End Function
