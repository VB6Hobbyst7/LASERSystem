...
Public Class frmReceive
    ...
    Private Sub cmdReceiptSticker_Click(sender As Object, e As EventArgs) Handles cmdReceiptSticker.Click
        SaveReceive()
        PrintReceipt(txtRNo.Text, True)
        PrintSticker(txtRNo.Text, True)
    ...
    Public Sub PrintReceipt(RNo As String, boolPrint As Boolean)
        ...
        Dim DA2 As New OleDb.OleDbDataAdapter("Select Return.RetNo,RepNo,PCategory,Pname,PModelNo," &
                                              "PSerialNo,Qty,Problem,'' as RetRemarks1 from Return,Product,Receive " &
    ...
    Public Sub PrintSticker(RNo As String, boolPrint As Boolean)
