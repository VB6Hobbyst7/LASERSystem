...
Public Class rptSettlementSale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptSettlementSale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSettlementSale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSettlementSale = New rptSettlementSale()
        rpt.Site = Me.Site
        Return rpt
    End Function
