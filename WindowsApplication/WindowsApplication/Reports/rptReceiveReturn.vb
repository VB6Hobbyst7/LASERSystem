...
Public Class rptReceiveReturn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptReceiveReturn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceiveReturn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceiveReturn = New rptReceiveReturn()
        rpt.Site = Me.Site
        Return rpt
    End Function
