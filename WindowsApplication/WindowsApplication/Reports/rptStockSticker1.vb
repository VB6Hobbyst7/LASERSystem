...
Public Class rptStockSticker
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptStockSticker.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockSticker
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockSticker = New rptStockSticker()
        rpt.Site = Me.Site
        Return rpt
    End Function
