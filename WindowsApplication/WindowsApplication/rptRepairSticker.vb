...
Public Class rptRepairSticker
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LASERSystem.rptRepairSticker.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepairSticker
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepairSticker = New rptRepairSticker()
        rpt.Site = Me.Site
        Return rpt
    End Function
